...
def main():
	...
	st.set_page_config(page_title="Czy przeżyłbyś katastrofę Titanica?")
	...
	with right:
		...
		fare_slider = st.slider("Cena biletu", min_value=0, max_value=512, step=1) # 512,3292 zaokrąglone do pełnego int
